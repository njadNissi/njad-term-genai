...
from .loc_ale import set_lang, get_lang
import locale

data_dir = Path.home() / '.term-genai'
data_dir.mkdir(parents=True, exist_ok=True)
config_path = data_dir / 'config.ini'
if not config_path.exists():
    with config_path.open('w') as f:
        f.write(read_text('term-genai', 'config.ini'))
...
class ChatMode:
    ...
    def toggle_raw_mode(cls):
        ...
        if cls.raw_mode:
            console.print(_("term-genai.raw_mode_enabled"))
        else:
            console.print(_("term-genai.raw_mode_disabled"))
    ...
    def toggle_stream_mode(cls):
        ...
        if cls.stream_mode:
            console.print(
                _("term-genai.stream_mode_enabled"))
        else:
            console.print(
                _("term-genai.stream_mode_disabled"))
    ...
    def toggle_multi_line_mode(cls):
        ...
        if cls.multi_line_mode:
            console.print(
                _("term-genai.multi_line_enabled"))
        else:
            console.print(_("term-genai.multi_line_disabled"))
